...
public interface IOrderService
{
    ...
    Task<ApiResponse<List<OrderDto>>> GetAllOrdersAsync(int page = 1, int pageSize = 20, string? status = null, DateTime? startDate = null, DateTime? endDate = null); // Admin
    ...
    Task<ApiResponse<DashboardStatsDto>> GetDashboardStatsAsync(string? selectedDate = null, string? selectedMonth = null);
}
